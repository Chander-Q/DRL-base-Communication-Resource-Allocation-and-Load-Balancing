...
def get_config():
    ...
    parser.add_argument(
        ...
        type=int,
        default=1e5,
        help="Number of environment steps to train (default: 10e6), episodes = num_env_steps // episode_length // n_rollout_threads",
    )
    parser.add_argument(
        "--user_name",
        type=str,
    ...
    # replay buffer parameters，就是step
    ...
    parser.add_argument(
        "--model_dir",
        type=str,
        default="results/MyEnv/MyEnv/mappo/check/run48/models",
    ...
    parser.add_argument(
        ...
        type=bool,
        default=True,
        help="by default False. set True to use test mode.",
    )
